...
layout = html.Div([
        ...
        html.Div([  
                html.Div([
                    ...
                    html.Div( id='indicator-graphic-data', children=[]),
                    html.Br(),
                    html.Div([
                ...
                html.Div([
                    ...
                    html.Div([
                        html.H5("Select Year Range"),
                            dcc.RangeSlider(2010, 2020, 1, value=[2010,2014], id='year',marks=None,
                        tooltip={"placement": "bottom", "always_visible": True})],className='create_container2 six columns'),
                    html.Div([
                        html.H5("Select Mine ID"),
...
def store_data(data_set_chosen):
    if data_set_chosen == None:
        return {}
    query = "Select * from `peak-essence-367304.MSHA."+data_set_chosen.upper()+"` limit 1000;"
...
@callback(
    ...
    Output('indicator-graphic-data', 'children'),
