...
layout = html.Div([
        ...
        html.Div([
            html.Div([
                html.Div([
                html.Div([html.H5('YEAR')], id = 'title2'),
            ...
            html.Div([
                html.Div([
                html.Div([html.H5('TIME')], id = 'title2'),
            ...
            html.Div([
                html.Div([
                html.Div([html.H5('OPERATOR OR CONTRACTOR')], id = 'title2'),
            ...
            html.Div([
                html.Div([
                html.Div([html.H5('ACCIDENT DATE')], id = 'title2'),
        ...
        html.Div([
            ...
            html.Div([
                html.Div([
                html.Div([html.H5('OCCUPATION CATEGORY')], id = 'title2'),
        ...
        html.Div([
            html.Div([
                html.Div([
                html.Div([html.H5('ACTIVITY CATEGORY')], id = 'title2'),
            ...
            html.Div([
                html.Div([
                html.Div([html.H5('NATURE OF INJURY')], id = 'title2'),
            ...
            html.Div([
                html.Div([
                html.Div([html.H5('INJURY BODY PART')], id = 'title2'),
        ...
        html.Div([
            ...
            html.Div([
                ...
                html.Br(),
                html.Div([dcc.Graph(id='graph124')]),
                ],className='create_container2 six columns'),
            ], className='row flex-display'),            
    ])
...
(SELECT MINE_ID,ACCIDENT_DT AS accident_date,CAL_YR,ACCIDENT_TIME AS time, ACTIVITY as activity_category, NATURE_INJURY as nature_of_injury, OCCUPATION AS occupation_category, INJ_BODY_PART as injury_body_part, COAL_METAL_IND as mining_method, DAYS_LOST, DAYS_RESTRICT from `peak-essence-367304.MSHA.ACCIDENTS`),
req_mines as 
(SELECT MINE_ID,COAL_METAL_IND,CURRENT_MINE_TYPE as mining_type, STATE as state FROM `peak-essence-367304.MSHA.MINES`),
req_violations as 
(SELECT VIOLATOR_TYPE_CD as operator_contractor, MINE_ID, NO_AFFECTED, CAL_YR FROM `peak-essence-367304.MSHA.VIOLATIONS`)
